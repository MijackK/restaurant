...
const navFactory = (() => {
  ...
  themeSlider.style.flexDirection =
    localStorage.theme == "dark" ? "row-reverse" : "row";
  themeSlider.style.backgroundColor =
    localStorage.theme == "dark" ? "#0997a3" : "rgb(168, 168, 127)";
  //non DOM varaibles
  ...
  const switcher = function (link) {
    if (link.id == currentlySelected) return;
  ...
  const themeHandler = () => {
    if (localStorage.theme) {
      if (localStorage.theme == "light") {
        ...
        document.querySelector(".galdin-video").src =
          "https://gta5mod.net/wp-content/uploads/2020/06/Final-Fantasy-XV-Galdin-Quay.jpg";
        document.querySelector(
          ".img-invisible"
        ).style.backgroundImage = `url('https://i.imgur.com/z3PX2uk.png')`;
        document.querySelector(
          ".img-visible"
        ).style.backgroundImage = `url('https://i.imgur.com/enudYqV.jpg')`;
        return;
      }
      ...
      document.querySelector(
        ".img-invisible"
      ).style.backgroundImage = `url('https://i.imgur.com/gkeuUxp.jpg')`;
      document.querySelector(
        ".img-visible"
      ).style.backgroundImage = `url('https://i.imgur.com/bnLWCgA.jpg')`;
    }
  };
